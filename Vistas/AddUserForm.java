...
//Creamos instancia del tipo ComboboxModel
    ...
    private void btnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmActionPerformed
        ...
        if (documentType==0)
            ...
            documentTypeN="Cedula de Extranjera";
        ...
        if (name.isEmpty() || lastname.isEmpty() || document.isEmpty() || email.isEmpty()) {
            ...
            String queryNuevoEmpleado = "INSERT INTO `empleado`(`nombreEmpleado`, `apellidos`, `tipoDocumento`, `documento`, `correo`, `FK_idSucursal`) VALUES ('"
